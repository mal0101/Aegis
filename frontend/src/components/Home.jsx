...
import { Brain, BookOpen, BarChart3, ArrowRight, CheckCircle2, Shield } from 'lucide-react';
      ...
      <section>
        <div className="mb-8">
          ...
          <p className="text-gray-500 max-w-lg text-sm">
            Designed for precision and evidence-based governmental decision-making processes.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-4 shrink-0">
            ...
            <div className="bg-rich-black rounded-xl p-6 w-52 text-white">
              <p className="text-xs font-semibold text-violet-blue-200 uppercase tracking-wider mb-3">Performance</p>
              <p className="text-3xl font-bold mb-0.5">&lt;2s</p>
              <p className="text-lg font-bold italic mb-1">Response</p>
              <p className="text-sm text-gray-400 mb-4">Groq-Powered Inference</p>
              <div className="flex items-center gap-1.5 text-xs text-gray-400">
                <Shield size={12} className="text-violet-blue-200" />
                <span className="font-semibold uppercase tracking-wide">70B Parameter Model</span>
              </div>
            </div>
          </div>
        </div>
